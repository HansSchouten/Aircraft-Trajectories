...
namespace AircraftTrajectories.Models.Contours
{
    public class Contour
    {
        ...
        public static IEnumerable<Contour> CreateContours(double[][] data, out IEnumerable<ContourPoint>[][] hgrid, out IEnumerable<ContourPoint>[][] vgrid)
        {
            ...
            listCoordinates(data, hgrid, vgrid);

            return GenerateContours(vgrid, hgrid);
        }

        /// <summary>
        /// Generate contourpoints for each real coordinate
        /// </summary>
        /// <param name="data"></param>
        /// <param name="hgrid"></param>
        /// <param name="vgrid"></param>
        private static void listCoordinates(double[][] data, IEnumerable<ContourPoint>[][] hgrid, IEnumerable<ContourPoint>[][] vgrid)
        {
            for (int x = 0; x < data.Length; x++) {
                ...
                for (int y = 0; y < data[x].Length; y++) {
                    var value = data[x][y];
                    if (x != 0) {
                        listVerticalContourPoints(vgrid, x, y, value, data);
                    }
                    if (y < data[x].Length - 1) {
                        listHorizontalContourPoints(hgrid, x, y, value, data);
                    }
                }
            }
        }
        ...
        /// <summary>
        /// List all contourpoints that fall into the vertical grid
        /// </summary>
        /// <param name="vgrid"></param>
        /// <param name="x"></param>
        /// <param name="y"></param>
        ...
        /// <param name="data"></param>
        private static void listVerticalContourPoints(IEnumerable<ContourPoint>[][] vgrid, int x, int y, double value, double[][] data)
        {
        ...
        /// <summary>
        /// List all contourpoints that fall into the horizontal grid
        /// </summary>
        /// <param name="vgrid"></param>
        /// <param name="x"></param>
        /// <param name="y"></param>
        /// <param name="value"></param>
        /// <param name="data"></param>
        private static void listHorizontalContourPoints(IEnumerable<ContourPoint>[][] hgrid, int x, int y, double value, double[][] data)
        {
        ...
        private static IEnumerable<Contour> GenerateContours(IEnumerable<ContourPoint>[][] vgrid, IEnumerable<ContourPoint>[][] hgrid)
        {
            ...
            findCircles(vgrid, hgrid);
        }

        /// <summary>
        /// Iterate the frame in the east and west direction to find contours
        /// </summary>
        /// <param name="vgrid"></param>
        /// <param name="hgrid"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Walk through the grid cells to find circle patterns
        /// </summary>
        /// <param name="vgrid"></param>
        /// <param name="hgrid"></param>
        /// <returns></returns>
